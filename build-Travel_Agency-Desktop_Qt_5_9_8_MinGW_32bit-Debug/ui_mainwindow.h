...
{
public:
    QPushButton *pb_annonce;
    QPushButton *pb_reservation;
    QPushButton *pb_paiement;
    QPushButton *pb_reclamation;
    QPushButton *pb_agent;
    QPushButton *pb_departement;
    QPushButton *pb_client;
    QPushButton *pb_media;
    QPushButton *pb_compagne;
    QPushButton *pb_pub;
    QPushButton *pb_back;
    QLabel *label;
...
"  padding: 0px;\n"
"}"));
        pb_annonce = new QPushButton(MainWindow);
        pb_annonce->setObjectName(QStringLiteral("pb_annonce"));
        pb_annonce->setGeometry(QRect(10, 120, 75, 23));
        pb_reservation = new QPushButton(MainWindow);
        pb_reservation->setObjectName(QStringLiteral("pb_reservation"));
        pb_reservation->setGeometry(QRect(170, 120, 75, 23));
        pb_paiement = new QPushButton(MainWindow);
        pb_paiement->setObjectName(QStringLiteral("pb_paiement"));
        pb_paiement->setGeometry(QRect(250, 120, 75, 23));
        pb_reclamation = new QPushButton(MainWindow);
        pb_reclamation->setObjectName(QStringLiteral("pb_reclamation"));
        pb_reclamation->setGeometry(QRect(330, 120, 75, 23));
        pb_agent = new QPushButton(MainWindow);
        pb_agent->setObjectName(QStringLiteral("pb_agent"));
        pb_agent->setGeometry(QRect(410, 120, 75, 23));
        pb_departement = new QPushButton(MainWindow);
        pb_departement->setObjectName(QStringLiteral("pb_departement"));
        pb_departement->setGeometry(QRect(490, 120, 75, 23));
        pb_client = new QPushButton(MainWindow);
        pb_client->setObjectName(QStringLiteral("pb_client"));
        pb_client->setGeometry(QRect(90, 120, 75, 23));
        pb_media = new QPushButton(MainWindow);
        pb_media->setObjectName(QStringLiteral("pb_media"));
        pb_media->setGeometry(QRect(570, 120, 75, 23));
        pb_compagne = new QPushButton(MainWindow);
        pb_compagne->setObjectName(QStringLiteral("pb_compagne"));
        pb_compagne->setGeometry(QRect(650, 120, 75, 23));
        pb_pub = new QPushButton(MainWindow);
        pb_pub->setObjectName(QStringLiteral("pb_pub"));
        pb_pub->setGeometry(QRect(730, 120, 75, 23));
        pb_back = new QPushButton(MainWindow);
        pb_back->setObjectName(QStringLiteral("pb_back"));
        pb_back->setGeometry(QRect(280, 70, 241, 23));
        label = new QLabel(MainWindow);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(130, 170, 561, 311));
        label->setPixmap(QPixmap(QString::fromUtf8("../../../Downloads/simplify-tour-operator-business (1).png")));
    ...
    void retranslateUi(QDialog *MainWindow)
    {
        ...
        pb_annonce->setText(QApplication::translate("MainWindow", "Annonce", Q_NULLPTR));
        pb_reservation->setText(QApplication::translate("MainWindow", "Reservation", Q_NULLPTR));
        pb_paiement->setText(QApplication::translate("MainWindow", "Paiement", Q_NULLPTR));
        pb_reclamation->setText(QApplication::translate("MainWindow", "Reclamation", Q_NULLPTR));
        pb_agent->setText(QApplication::translate("MainWindow", "Agent", Q_NULLPTR));
        pb_departement->setText(QApplication::translate("MainWindow", "Departement", Q_NULLPTR));
        pb_client->setText(QApplication::translate("MainWindow", "Client", Q_NULLPTR));
        pb_media->setText(QApplication::translate("MainWindow", "Media", Q_NULLPTR));
        pb_compagne->setText(QApplication::translate("MainWindow", "Compagne", Q_NULLPTR));
        pb_pub->setText(QApplication::translate("MainWindow", "Publicit\303\251", Q_NULLPTR));
        pb_back->setText(QApplication::translate("MainWindow", "Login Menu", Q_NULLPTR));
