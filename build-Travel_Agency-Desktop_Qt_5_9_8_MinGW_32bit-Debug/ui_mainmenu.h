...
public:
    ...
    void setupUi(QDialog *MainMenu)
    {
        ...
        MainMenu->resize(806, 506);
        MainMenu->setStyleSheet(QLatin1String("/* ---------------------------------------------------------------------------\n"
"\n"
...
"  padding: 0px;\n"
"}"));
        pb_Connect = new QPushButton(MainMenu);
        pb_Connect->setObjectName(QStringLiteral("pb_Connect"));
        pb_Connect->setGeometry(QRect(250, 410, 301, 23));
        pb_Connect->setMinimumSize(QSize(291, 0));
        lineEdit_password = new QLineEdit(MainMenu);
        lineEdit_password->setObjectName(QStringLiteral("lineEdit_password"));
        lineEdit_password->setGeometry(QRect(250, 360, 301, 20));
        ...
        lineEdit_username = new QLineEdit(MainMenu);
        lineEdit_username->setObjectName(QStringLiteral("lineEdit_username"));
        lineEdit_username->setGeometry(QRect(250, 310, 301, 20));
        label = new QLabel(MainMenu);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(240, 60, 321, 191));
        label->setPixmap(QPixmap(QString::fromUtf8("../../0885a2a38cdbee4f21a0e006edfd5ce3.png")));
    ...
    void retranslateUi(QDialog *MainMenu)
    {
        ...
        pb_Connect->setText(QApplication::translate("MainMenu", "Connect", Q_NULLPTR));
        lineEdit_password->setText(QString());
        lineEdit_password->setPlaceholderText(QApplication::translate("MainMenu", "                                         Password", Q_NULLPTR));
        lineEdit_username->setPlaceholderText(QApplication::translate("MainMenu", "                                         Username", Q_NULLPTR));
